 ...
 */
@RestController
@RequestMapping("/admin/api/adminDepartment")
public class AdminDepartmentController {
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           ...
                           AdminDepartment form) {
        Page<AdminDepartment> list = adminDepartmentService.findAll(form, pageNum, pageSize);
    ...
    public JsonResult detail(@PathVariable Integer id) {
        AdminDepartment adminDepartment = adminDepartmentService.getById(id);
        return JsonResult.ok(adminDepartment);
    }

    @ApiOperation("保存")
    @PostMapping({"", "/save"})
    public JsonResult save(@RequestBody @Validated AdminDepartment adminDepartment,
        ...
        boolean flag = adminDepartmentService.save(adminDepartment);
    ...
    public JsonResult delete(@PathVariable Integer id) {
        boolean flag = adminDepartmentService.deleteById(id);
        return JsonResult.ok(flag);
    }
