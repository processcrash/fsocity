 ...
 */
@RestController
@RequestMapping("/admin/api/adminUserPosition")
public class AdminUserPositionController {
...
private AdminUserPositionService adminUserPositionService;
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           ...
                           AdminUserPosition form) {
        Page<AdminUserPosition> list = adminUserPositionService.findAll(form, pageNum, pageSize);
    ...
    public JsonResult detail(@PathVariable Integer id) {
        AdminUserPosition adminUserPosition = adminUserPositionService.getById(id);
        return JsonResult.ok(adminUserPosition);
    }

    @ApiOperation("保存")
    @PostMapping("/save")
    public JsonResult save(@RequestBody @Validated AdminUserPosition adminUserPosition,
        ...
        boolean flag = adminUserPositionService.save(adminUserPosition);
    ...
    public JsonResult delete(@PathVariable Integer id) {
        boolean flag = adminUserPositionService.deleteById(id);
        return JsonResult.ok(flag);
    }
