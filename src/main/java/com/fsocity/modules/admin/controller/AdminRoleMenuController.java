 ...
 */
@RestController
@RequestMapping("/admin/api/adminRoleMenu")
...
private AdminRoleMenuService adminRoleMenuService;
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           ...
                           AdminRoleMenu form) {
        Page<AdminRoleMenu> list = adminRoleMenuService.findAll(form, pageNum, pageSize);
    ...
    public JsonResult detail(@PathVariable Integer id) {
        AdminRoleMenu adminRoleMenu = adminRoleMenuService.getById(id);
        return JsonResult.ok(adminRoleMenu);
    }

    @ApiOperation("保存")
    @PostMapping("/save")
    public JsonResult save(@RequestBody @Validated AdminRoleMenu adminRoleMenu,
        ...
        boolean flag = adminRoleMenuService.save(adminRoleMenu);
    ...
    public JsonResult delete(@PathVariable Integer id) {
        boolean flag = adminRoleMenuService.deleteById(id);
        return JsonResult.ok(flag);
    }
