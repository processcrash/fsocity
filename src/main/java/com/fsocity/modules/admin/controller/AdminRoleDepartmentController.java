 ...
 */
@RestController
@RequestMapping("/admin/api/adminRoleDepartment")
public class AdminRoleDepartmentController {

@Autowired
private AdminRoleDepartmentService adminRoleDepartmentService;

    @ApiOperation("列表")
    @GetMapping("/list")
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize,
                           AdminRoleDepartment form) {
        Page<AdminRoleDepartment> list = adminRoleDepartmentService.findAll(form, pageNum, pageSize);
    ...
    public JsonResult detail(@PathVariable Integer id) {
        AdminRoleDepartment adminRoleDepartment = adminRoleDepartmentService.getById(id);
        return JsonResult.ok(adminRoleDepartment);
    }

    @ApiOperation("保存")
    @PostMapping("/save")
    public JsonResult save(@RequestBody @Validated AdminRoleDepartment adminRoleDepartment,
        ...
        boolean flag = adminRoleDepartmentService.save(adminRoleDepartment);
    ...
    public JsonResult delete(@PathVariable Integer id) {
        boolean flag = adminRoleDepartmentService.deleteById(id);
        return JsonResult.ok(flag);
    }
