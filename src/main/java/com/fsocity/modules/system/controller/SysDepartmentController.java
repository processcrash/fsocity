 ...
 */
@RestController
@RequestMapping("/admin/api/system/sysDepartment")
public class SysDepartmentController {
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
        ...
        Page<SysDepartment> list = sysDepartmentService.findAll(pageSize, pageNum);
    ...
    @ApiOperation("修改")
    @PostMapping("/edit")
    public JsonResult edit(@RequestBody @Validated SysDepartment sysDepartment,
    ...
    public JsonResult delete(@PathVariable Integer id) {
        SysDepartment sysDepartment = sysDepartmentService.deleteById(id);
        return JsonResult.ok();
    }
}
