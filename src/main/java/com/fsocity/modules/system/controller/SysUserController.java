 ...
 */
@RestController
@RequestMapping("/system/api/sysUser")
...
private SysUserService sysUserService;
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           ...
                           SysUser form) {
        Page<SysUser> list = sysUserService.findAll(form, pageNum, pageSize);
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    public JsonResult save(@RequestBody @Validated SysUser sysUser,
