 ...
 */
@RestController
@RequestMapping("/admin/api/system/sysUser")
public class SysUserController {
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
        ...
        Page<SysUser> list = sysUserService.findAll(pageSize, pageNum);
    ...
    @ApiOperation("修改")
    @PostMapping("/edit")
    public JsonResult edit(@RequestBody @Validated SysUser sysUser,
    ...
    public JsonResult delete(@PathVariable Integer id) {
        SysUser sysUser = sysUserService.deleteById(id);
        return JsonResult.ok();
    }
}
