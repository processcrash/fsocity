 ...
 */
@RestController
@RequestMapping("/system/api/sysConfig")
...
private SysConfigService sysConfigService;
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           ...
                           SysConfig form) {
        Page<SysConfig> list = sysConfigService.findAll(form, pageNum, pageSize);
    ...
    public JsonResult save(@RequestBody @Validated SysConfig sysConfig,
        ...
        boolean flag = sysConfigService.save(sysConfig);
    ...
    public JsonResult delete(@PathVariable Integer id) {
        boolean flag = sysConfigService.deleteById(id);
        return JsonResult.ok(flag);
    }
