 ...
 */
@RestController
@RequestMapping("/system/api/sysDictionaryData")
...
private SysDictionaryDataService sysDictionaryDataService;
    ...
    public JsonResult list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                           ...
                           SysDictionaryData form) {
        Page<SysDictionaryData> list = sysDictionaryDataService.findAll(form, pageNum, pageSize);
    ...
    public JsonResult save(@RequestBody @Validated SysDictionaryData sysDictionaryData,
        ...
        boolean flag = sysDictionaryDataService.save(sysDictionaryData);
    ...
    public JsonResult delete(@PathVariable Integer id) {
        boolean flag = sysDictionaryDataService.deleteById(id);
        return JsonResult.ok(flag);
    }
