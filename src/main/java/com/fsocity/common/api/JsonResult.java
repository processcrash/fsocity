...
public class JsonResult {
    ...
    public static JsonResult of(ResponseStatusEnum e) {
        return new JsonResult(e.getCode(), e.getMessage(), null);
    }
    
    public static JsonResult of(ResponseStatusEnum e, Object data) {
    ...
    public static JsonResult fail(ResponseStatusEnum e) {
        return JsonResult.of(e);
    }
